...
const Layout = () => {
  ...
  const defaultMenu = [
    ...
    { key: 'roadTax', text: t('nav.roadTax'), icon: <AttachMoney />, path: '/road-tax', featureKey: 'tax.view' },
    { key: 'motRecords', text: t('nav.motRecords'), icon: <Assignment />, path: '/mot-records', featureKey: 'mot.view' },
    { key: 'serviceRecords', text: t('nav.serviceRecords'), icon: <HomeRepairService />, path: '/service-records', featureKey: 'services.view' },
    { key: 'stock', text: t('nav.stock', 'Stock'), icon: <Inventory />, path: '/stock' },
    { key: 'parts', text: t('nav.parts'), icon: <Build />, path: '/parts', featureKey: 'parts.view' },
    { key: 'consumables', text: t('nav.consumables'), icon: <Opacity />, path: '/consumables', featureKey: 'consumables.view' },
    ...
    { key: 'todo', text: t('nav.todo') || 'TODO', icon: <Checklist />, path: '/todo', featureKey: 'todos.view' },

 ...
 */
final class Version20260128205208 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE attachments (id INT AUTO_INCREMENT NOT NULL, vehicle_id INT DEFAULT NULL, service_record_id INT DEFAULT NULL, user_id INT NOT NULL, filename VARCHAR(255) NOT NULL, original_name VARCHAR(255) NOT NULL, thumbnail_path VARCHAR(255) DEFAULT NULL, mime_type VARCHAR(100) NOT NULL, file_size INT NOT NULL, uploaded_at DATETIME NOT NULL, entity_type VARCHAR(50) DEFAULT NULL, entity_id INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, storage_path VARCHAR(255) DEFAULT NULL, category VARCHAR(50) DEFAULT NULL, INDEX IDX_47C4FAD6545317D1 (vehicle_id), INDEX IDX_47C4FAD6156C4F46 (service_record_id), INDEX IDX_47C4FAD6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

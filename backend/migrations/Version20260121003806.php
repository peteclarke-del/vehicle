 ...
 */
final class Version20260121003806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE service_items (id INT AUTO_INCREMENT NOT NULL, service_record_id INT NOT NULL, type VARCHAR(20) NOT NULL, description VARCHAR(255) DEFAULT NULL, cost NUMERIC(10, 2) NOT NULL, quantity INT DEFAULT 1 NOT NULL, INDEX IDX_486C04AA156C4F46 (service_record_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
